            ...
            <div class="row">
                ...
                <div class="col-lg-4 text-left text-lg-center mb-3 mb-lg-0">
                    <div class="d-inline-flex text-left">
                        ...
                        <div class="d-flex flex-column">
                            <h5>Email Us</h5>
                            <p class="m-0">info@idesign.gmail.com</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7 m-0 my-lg-5 pt-5 pb-5 pb-lg-2 pl-lg-5">
                    ...
                    <h1 class="mb-4 section-title">Leading Experts in Home Decor and Design</h1>
                    <p>At iDESIGN, we specialize in creating beautiful and functional spaces tailored to your needs. With over 25 years of experience in the industry, our team is dedicated to delivering exceptional results for both residential and commercial projects. From concept to completion, we ensure every detail is meticulously handled to bring your vision to life.</p>
                    <div class="row py-2">
                        <div class="col-sm-6">
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-6 pr-lg-5">
                    <h6 class="text-primary font-weight-normal text-uppercase mb-3">Our Premier Services</h6>
                    <h1 class="mb-4 section-title">Exceptional Interior Design Services for Your Home</h1>
                    <p>At iDESIGN, we offer a range of top-notch interior design services tailored to meet your specific needs and preferences. Our team of experienced designers works closely with you to create stunning and functional spaces that enhance your lifestyle. Whether you're looking to redesign your bedroom, kitchen, or bathroom, we provide expert guidance and innovative solutions to bring your vision to life.</p>
                ...
                <div class="col-lg-6 p-0 pt-5 pt-lg-0">
                    <div class="owl-carousel service-carousel position-relative">
                        <div class="d-flex flex-column text-center bg-light mx-3 p-4">
                            ...
                            <h5 class="mb-3">Elegant Bedroom Design</h5>
                            <p class="m-0">Transform your bedroom into a peaceful retreat with our elegant designs that combine comfort and style. </p>
                        </div>
                        <div class="d-flex flex-column text-center bg-light mx-3 p-4">
                            <h3 class="flaticon-kitchen display-3 font-weight-normal text-primary mb-3"></h3>
                            <h5 class="mb-3">Modern Kitchen Design</h5>
                            <p class="m-0">Upgrade your kitchen with our modern designs that emphasize functionality and aesthetic appeal.</p>
                        </div>
                        <div class="d-flex flex-column text-center bg-light mx-3 p-4">
                            <h3 class="flaticon-bathroom display-3 font-weight-normal text-primary mb-3"></h3>
                            <h5 class="mb-3">Luxurious Bathroom Design</h5>
                            <p class="m-0">Create a luxurious bathroom experience with our bespoke designs that combine elegance and comfort.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 mt-5 py-5 pr-lg-5">
                    ...
                    <p class="mb-4">With over 25 years of experience in the interior design industry, we have built a reputation for delivering exceptional design solutions that enhance the functionality and aesthetic of any space. Our team of skilled designers is committed to understanding your unique needs and preferences, ensuring every project is tailored to your vision and exceeds your expectations.</p>

                    <ul class="list-inline">
                        <li><h5><i class="far fa-check-square text-primary mr-3"></i>25+ Years Experience</h5></li>
                        <li><h5><i class="far fa-check-square text-primary mr-3"></i>Top-Quality Interior Design</h5></li>
                        <li><h5><i class="far fa-check-square text-primary mr-3"></i>Unmatched Customer Satisfaction</h5></li>
                    </ul>
                    <!-- <a href="" class="btn btn-primary mt-3 py-2 px-4">View More</a> -->
                </div>
                <div class="col-lg-5">
            ...
            <div class="row mx-1 portfolio-container">
                <div class="col-lg-4 col-md-6 col-sm-12 p-0 portfolio-item first">
                    <div class="position-relative overflow-hidden">
                        ...
                        <div class="portfolio-text bg-secondary d-flex flex-column align-items-center justify-content-center">
                            <h4 class="text-white mb-4">Elegant Drawing Room</h4>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 p-0 portfolio-item second">
                    <div class="position-relative overflow-hidden">
                        ...
                        <div class="portfolio-text bg-secondary d-flex flex-column align-items-center justify-content-center">
                            <h4 class="text-white mb-4">Modern Dining Room</h4>
                            <div class="d-flex align-items-center justify-content-center">
                                <!-- <a class="btn btn-outline-primary m-1" href="">
                                    <i class="fa fa-link"></i>
                                </a> -->
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 p-0 portfolio-item third">
                    <div class="position-relative overflow-hidden">
                        ...
                        <div class="portfolio-text bg-secondary d-flex flex-column align-items-center justify-content-center">
                            <h4 class="text-white mb-4">Decorated Living Room</h4>
                            <div class="d-flex align-items-center justify-content-center">
                                <!-- <a class="btn btn-outline-primary m-1" href="">
                                    <i class="fa fa-link"></i>
                                </a> -->
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 p-0 portfolio-item first">
                    <div class="position-relative overflow-hidden">
                        ...
                        <div class="portfolio-text bg-secondary d-flex flex-column align-items-center justify-content-center">
                            <h4 class="text-white mb-4">Charming Balcony</h4>
                            <div class="d-flex align-items-center justify-content-center">
                                <!-- <a class="btn btn-outline-primary m-1" href="">
                                    <i class="fa fa-link"></i>
                                </a> -->
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 p-0 portfolio-item second">
                    <div class="position-relative overflow-hidden">
                        ...
                        <div class="portfolio-text bg-secondary d-flex flex-column align-items-center justify-content-center">
                            <h4 class="text-white mb-4">Stylish Living Room</h4>
                            <div class="d-flex align-items-center justify-content-center">
                                <!-- <a class="btn btn-outline-primary m-1" href="">
                                    <i class="fa fa-link"></i>
                                </a> -->
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 p-0 portfolio-item third">
                    <div class="position-relative overflow-hidden">
                        ...
                        <div class="portfolio-text bg-secondary d-flex flex-column align-items-center justify-content-center">
                            <h4 class="text-white mb-4">Cozy Guest Room</h4>
                            <div class="d-flex align-items-center justify-content-center">
                                <!-- <a class="btn btn-outline-primary m-1" href="">
                                    <i class="fa fa-link"></i>
                                </a> -->
                    ...
                    <div class="owl-carousel team-carousel position-relative p-0 py-sm-5">
                        <div class="team d-flex flex-column text-center mx-3">
                            ...
                            <div class="d-flex flex-column bg-secondary text-center py-3">
                                <h5 class="text-white">Carlos Gómez</h5>
                            <p class="m-0">Visual Designer</p>
                            </div>
                        </div>
                        <div class="team d-flex flex-column text-center mx-3">
                            <div class="position-relative">
                            ...
                            <div class="d-flex flex-column bg-secondary text-center py-3">
                                <h5 class="text-white">Luca Rossi</h5>
                        ...
                        <div class="team d-flex flex-column text-center mx-3">
                            ...
                            <div class="d-flex flex-column bg-secondary text-center py-3">
                                <h5 class="text-white">Sophia Johnson</h5>
                        ...
                        <div class="team d-flex flex-column text-center mx-3">
                            ...
                            <div class="d-flex flex-column bg-secondary text-center py-3">
                                <h5 class="text-white">Mia Müller</h5>
                                <p class="m-0">Interior Architect</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="owl-carousel testimonial-carousel position-relative pb-5 mb-md-5">
                        <div class="d-flex flex-column">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="ml-3">
                                    <h5>Jack Romson</h5>
                                    <i>CEO, Tech Innovations</i>
                                </div>
                            </div>
                            <p>"Working with this team was a game-changer for our business. Their expertise in interior design transformed our office space into a modern, functional environment that our employees love. The attention to detail and creativity were exceptional. Highly recommended!"</p>
                        </div>
                        <div class="d-flex flex-column">
                            <div class="d-flex align-items-center mb-3">
                            ...
                            <p class="m-0">"I am absolutely thrilled with the results of our home renovation. The design team took our ideas and turned them into a beautiful and functional space. From the initial consultation to the final touches, every step was handled with professionalism and care. My home has never looked better!"</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-5">
    ...
    <div class="container-fluid bg-dark text-white py-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p><i class="fa fa-envelope mr-2"></i>info@idesign.gmail.com</p>
            ...
            <div class="col-lg-3 col-md-6 mb-5" style="visibility:hidden;">
        ...
        <div class="container border-top border-secondary pt-5">
            <p class="m-0 text-center text-white">
                &copy; <a class="text-white font-weight-bold" href="#">i Design</a>. All Rights Reserved. Designed by IDESIGN
